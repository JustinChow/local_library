            ...
            var author = new Author(
                {
                    ...
                    // Time added to prevent timezone issues with ISO 8601 
                    // https://stackoverflow.com/questions/2587345/why-does-date-parse-give-incorrect-results
                    date_of_birth: req.body.date_of_birth + 'T00:00:00', 
                    date_of_death: req.body.date_of_death + 'T00:00:00'
                }
            );
...
exports.author_delete_get = function(req, res) {
    res.send('NOT IMPELMENTED: Author delete GET');
};
